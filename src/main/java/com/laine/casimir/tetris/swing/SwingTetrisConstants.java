...
public final class SwingTetrisConstants {
    ...
    public static final int WINDOW_DEFAULT_WIDTH = (Playfield.WIDTH + 8) * 50;
    public static final int WINDOW_DEFAULT_HEIGHT = Playfield.VISIBLE_HEIGHT * 50;
    public static final int WINDOW_MIN_WIDTH = (Playfield.WIDTH + 8) * 40;
    public static final int WINDOW_MIN_HEIGHT = Playfield.VISIBLE_HEIGHT * 40;
